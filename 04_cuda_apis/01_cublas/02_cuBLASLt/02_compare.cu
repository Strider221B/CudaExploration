...
int main() {
    ...
    // Note: Setting the below line does improve the f16 performance and makes it better than f32.
...
// Output:
// ~/Git/CudaExploration/04_cuda_apis/01_cublas/02_cuBLASLt$ nvcc -lcublas -lcublasLt -o 02_exec 02_compare.cu 
// ~/Git/CudaExploration/04_cuda_apis/01_cublas/02_cuBLASLt$ ./02_exec 
// matrix size: 4096x1024 * 1024x4096
// cuBLAS FP32 average time: 19.5276 ms
// cuBLASLt FP32 average time: 18.6285 ms
// cuBLAS FP16 average time: 93.8499 ms
// cuBLASLt FP16 average time: 93.862 ms
// Naive CUDA kernel average time: 106.928 ms
// max error fp16 cublas: 0.0866146
// max error fp16 cublasLt: 0.0866146
