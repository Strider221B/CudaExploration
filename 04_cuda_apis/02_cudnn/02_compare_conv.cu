...
// Output:
// ~/Git/CudaExploration/04_cuda_apis/02_cudnn$ nvcc -lcudnn  -o ./02_exec ./02_compare_conv.cu 
// ~/Git/CudaExploration/04_cuda_apis/02_cudnn$ ./02_exec 
// Image size: 224x224x32
// Kernel size: 11x11x32x64
// Batch size: 4
// cuDNN average time: 83.730507 ms
// Naive kernel average time: 437.105530 ms
