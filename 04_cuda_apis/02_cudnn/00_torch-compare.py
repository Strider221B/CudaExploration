...
# Outputs
# ~/Git/CudaExploration/04_cuda_apis/02_cudnn$ source ~/PythonEnvs/Py3.10.12_LLMUdemy/bin/activate
# ~/Git/CudaExploration/04_cuda_apis/02_cudnn$ python ./00_torch-compare.py 
# Using device: cuda
# Custom Tanh: Avg time per run: 363.506 ms
# Built-in Tanh: Avg time per run: 10.595 ms
