...
// Output
// ~/Git/CudaExploration/03_basic_kernels/03_profiling$ nvcc -o 02_exec 02_naive_matmul.cu -lnvToolsExt
// ~/Git/CudaExploration/03_basic_kernels/03_profiling$ nsys profile --stats=true ./02_exec
