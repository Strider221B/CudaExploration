...
// Output: GPU 3D is slower than GPU 1D because each thread has to do far more computation in 3D vs 1D. So use 3D only when necessary.
...
// CPU average time: 22.702128 milliseconds
// GPU 1D average time: 0.949208 milliseconds
// GPU 3D average time: 1.141194 milliseconds
// Speedup (CPU vs GPU 1D): 23.916915x
// Speedup (CPU vs GPU 3D): 19.893307x
// Speedup (GPU 1D vs GPU 3D): 0.831767x
